...
RSpec.describe ViewingParty, type: :model do
  before(:each) do
      @user_1 = User.create!(name: 'Sam', email: 'sam@email.com', password: 'password123', password_confirmation: 'password123')
      @user_2 = User.create!(name: 'Tommy', email: 'tommy@email.com', password: 'password123', password_confirmation: 'password123')
